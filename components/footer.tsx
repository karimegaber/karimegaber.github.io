...
export function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-slate-950/50 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 md:flex-row md:justify-between">
        ...
        <p className="flex items-center gap-1 font-mono text-xs text-slate-600">
          Built with <Heart size={12} className="text-blue-600 dark:text-blue-400" /> by{" "}
          <a
