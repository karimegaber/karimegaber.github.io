...
export function BlogPostClient() {
  ...
  // EMPTY SHELL GATE: If !hasMounted, return ONLY Skeleton UI.
  // This prevents build-time data baking.
  if (!hasMounted) {
    return (
      <main className="relative min-h-screen bg-[#080c1a]">
        <Navbar />
        <div className="pt-32 pb-20 px-6">
           {/* Static non-animated skeleton for initial SSR to avoid hydration mismatch with framer-motion if strict */}
           {/* But framer-motion is fine here as long as it mounts */}
           <BlogPostSkeleton />
        </div>
        <Footer />
      </main>
