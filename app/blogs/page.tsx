...
// Note: Explicitly omitted 'dynamic = force-dynamic' and 'revalidate = 0'
// because Next.js build (output: 'export') strictly forbids these exports
// inside a "use client" file. The "Empty Shell" hydration gate guarantees
// the static export contains zero baked data, fulfilling the core architectural goal.
