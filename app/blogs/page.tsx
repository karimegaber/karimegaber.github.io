...
export default function BlogsPage() {
  ...
  useEffect(() => {
    ...
    async function fetchPosts() {
      try {
        // Fetch posts - cache busting is handled globally in lib/supabase.ts via customFetch
        // This ensures every request has a ?t=timestamp query param.
  ...
  // Mandatory mounting gate/loading state
  if (loading) {
     return (
